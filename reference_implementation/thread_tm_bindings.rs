// ThreadTM reference source — SNAPSHOT for reading, not the build input.
// Canonical, tested source: topica v0.58.0 (e03da20dc37a7c87d6d3ddd847747a82ea7ee994)
//   src/python/thread_tm.rs
